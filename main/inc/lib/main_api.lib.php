...
// Report actions
define('REPORT_ACTION_BACK', 0);
define('REPORT_ACTION_MY_PROGRESS', 1);
define('REPORT_ACTION_MY_SPACE_TEACHER', 2);
define('REPORT_ACTION_MY_SPACE_ADMIN', 3);
define('REPORT_ACTION_MY_SPACE_DRH', 4);
define('REPORT_ACTION_STUDENTS', 5);
define('REPORT_ACTION_TEACHERS', 6);
define('REPORT_ACTION_COURSES', 7);
define('REPORT_ACTION_SESSIONS', 8);
define('REPORT_ACTION_EXAMS', 9);
define('REPORT_ACTION_CURRENT_COURSES', 10);
define('REPORT_ACTION_COMPANY_REPORT', 11);
define('REPORT_ACTION_COMPANY_SUMMARY', 12);
define('REPORT_ACTION_IMPORT_USER', 13);
define('REPORT_ACTION_TRACKING_STUDENTS', 14);
define('REPORT_ACTION_TRACKING_COURSES', 15);
define('REPORT_ACTION_TRACKING_RESOURCES', 16);
define('REPORT_ACTION_PRINT', 101);
define('REPORT_ACTION_EXPORT_XLS', 102);
define('REPORT_ACTION_EXPORT_CSV', 103);
/**
